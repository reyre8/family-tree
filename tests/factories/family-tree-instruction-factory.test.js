...
const Provider = require('./provider/family-tree-instruction-factory-provider');

describe('Test - FamilyTreeInstructionFactory', () => {
  it('Should return an instance of FamilyTreeInstruction', () => {
    const familyTreeInstruction = FamilyTreeInstructionFactory(Provider.params().familyTree);
